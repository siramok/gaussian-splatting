...
def loadCam(args, id, cam_info, resolution_scale, is_test_dataset):
    ...
    return Camera(
        ...
        opacitymap_id=cam_info.opacitymap_id,
...
def loadDirect(args, id, cam_info, resolution_scale, is_test_dataset):
    image = Image.open(cam_info.image_path)
    ...
    camera.from_direct(cam_info.mvt_matrix, cam_info.proj_matrix)
    return camera
